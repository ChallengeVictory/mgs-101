...
httpServer = TCPServer.new('0.0.0.0', httpPort)
...
loop {
	...
	s.print '<!DOCTYPE html><html><head><title>Torro</title>'
	# elagant-ify it, pl0x.
	...
	s.print '</head><body><center><h1>Torro</h1><hr>'
	...
	if !request.nil?
		...
		begin
			if request != '/' && request != '/?'
				...
				s.print '<br><video autoplay loop="loop" src="http://lolwaleet.com/cheers.mp4"></video><h2 style="font-family: \'Comic Sans MS\';">b0x pwn3d - good luck</h2><br>'
			end
		rescue Exception; end
	end
	s.print '<hr>El <span style="color: red">Torro</span><br></span></center><hr></body></html>'
	s.close
}
